...
CREATE TABLE Videojuegos (
    ...
    nombre VARCHAR(50) NOT NULL,          -- Nombre del videojuego
    genero VARCHAR(30),                   -- Género del videojuego (Ej: Acción, Aventura, RPG)
    estado TINYINT(1) NOT NULL DEFAULT 1  -- Estado del videojuego (1 = Activo, 0 = Inactivo)
);
...
CREATE TABLE Cines (
    idCines INT AUTO_INCREMENT PRIMARY KEY,   
